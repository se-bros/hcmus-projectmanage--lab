...
* [2. Định vị sản phẩm](#2-định-vị-sản-phẩm)
    ...
    * [2.3 Phân tích Quy trình Hiện tại (As-Is) và Quy trình Tương lai (To-Be)](#23-phân-tích-quy-trình-hiện-tại-as-is-và-quy-trình-tương-lai-to-be)
        * [2.3.1 Quy trình vận hành hiện tại (As-Is Workflow) và các Vấn đề cốt lõi](#231-quy-trình-vận-hành-hiện-tại-as-is-workflow-và-các-vấn-đề-cốt-lõi)
        * [2.3.2 Đề xuất Quy trình vận hành tương lai (To-Be Workflow) và các Tính năng mới](#232-đề-xuất-quy-trình-vận-hành-tương-lai-to-be-workflow-và-các-tính-năng-mới)
