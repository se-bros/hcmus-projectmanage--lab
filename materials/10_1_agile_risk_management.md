...
- Lập kế hoạch quản lý rủi ro.
  _(Create risk management plan.)_
...
_Dự toán số điểm câu chuyện có thể hoàn thành theo các mức tin cậy:_
...
- Điều gì về dự án khiến bạn lo lắng mất ngủ? _(What keeps you up at night?)_
...
3. **Giảm thiểu rủi ro (Mitigate):** Thực hiện các bước chủ động để giảm thiểu khả năng xảy ra hoặc giảm tác động của rủi ro.
   _(Có thể kết hợp các biện pháp này với nhau)._
