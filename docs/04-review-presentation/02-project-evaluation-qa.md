...
- **Trích dẫn chi tiết:**
  - [01-project-idea.md](../01-initiation/01-project-idea.md#L60-L68) — **Mục 3.1. Thực trạng và Vấn đề**:
  ...
  - [02-project-proposal.md](../01-initiation/02-project-proposal.md#L79-L95) — **Mục 2.1. Hành trình từ "Nỗi đau" vật lý...**:
  ...
  - [04-feasibility-study.md](../01-initiation/03-feasibility-study.md#L50-L55) — **Mục 2. Lý do thực hiện**:
...
- **Trạng thái:** ĐÃ CÓ TRONG TÀI LIỆU.
- **Trích dẫn chi tiết:**
  - [02-project-proposal.md](../01-initiation/02-project-proposal.md#L109-L111) — **Mục 2.3. Phân tích đối chuẩn: Đối thủ cạnh tranh**:
  ...
  - [03-vision-and-scope.md](../02-planning/01-vision-and-scope.md#L295-L306) — **Mục 3.6. So sánh đối chuẩn quy trình nghiệp vụ (Workflow Benchmarking)**:
  ...
  - [06-architecture.md](../02-planning/02-architecture.md#L213-L217) — **Mục 4.1. Vì sao không sử dụng DSpace?**:
...
- **Trạng thái:** ĐÃ CÓ TRONG TÀI LIỆU.
- **Trích dẫn chi tiết:**
  - [02-project-proposal.md](../01-initiation/02-project-proposal.md#L112-L120) — **Mục 2.3. Phương án kết hợp công cụ có sẵn**:
  ...
  - [03-vision-and-scope.md](../02-planning/01-vision-and-scope.md#L295-L306) — **Mục 3.6. Workflow Benchmarking**:
...
- **Trạng thái:** ĐÃ CÓ TRONG TÀI LIỆU.
- **Trích dẫn chi tiết:**
  - [02-project-proposal.md](../01-initiation/02-project-proposal.md#L201-L228) — **Mục 5. Phân tích các bên liên quan và Phân vai (Stakeholders & RACI)**:
  ...
  - [04-feasibility-study.md](../01-initiation/03-feasibility-study.md#L74-L99) — **Mục 5.1. Đánh giá 8 khía cạnh khả thi**:
...
- **Trạng thái:** ĐÃ CÓ TRONG TÀI LIỆU.
- **Trích dẫn chi tiết:**
  - [03-vision-and-scope.md](../02-planning/01-vision-and-scope.md#L109-L195) — **Mục 2.3. Phân tích Quy trình Hiện tại (As-Is) và Quy trình Tương lai (To-Be)**:
  ...
  - [05-project-charter.md](../01-initiation/04-project-charter.md#L75-L83) — **Mục 5.1. Ma trận Tác nhân và Tác động As-is vs To-be**:
...
- **Trạng thái:** ĐÃ CÓ TRONG TÀI LIỆU.
- **Trích dẫn chi tiết:**
  - [03-vision-and-scope.md](../02-planning/01-vision-and-scope.md#L295-L306) — **Mục 3.6. Workflow Benchmarking (Cột "Kết hợp công cụ rời rạc")**:
...
- **Trích dẫn chi tiết:**
  - **Trách nhiệm thực hiện (R) vs Trách nhiệm giải trình (A):**
    - [02-project-proposal.md](../01-initiation/02-project-proposal.md#L213-L228) & [05-project-charter.md](../01-initiation/04-project-charter.md#L90-L101) — **Mục Ma trận RACI**:
  ...
  - **Mức độ ảnh hưởng (Influence / Power-Interest):**
    - [05-project-charter.md](../01-initiation/04-project-charter.md#L84-L88) — **Mục 5.2. Bản đồ Stakeholder (Power/Interest Grid)**:
  ...
  - **Khả năng tiếp cận (Accessibility / Phân quyền RBAC):**
    - [03-vision-and-scope.md](../02-planning/01-vision-and-scope.md#L232-L247) (Mục 2.3.4), [06-architecture.md](../02-planning/02-architecture.md#L111-L150) (Mục 3 Use Case) & [06-architecture.md](../02-planning/02-architecture.md#L397-L404) (Mục 5.1 Security Layers):
...
- **Trạng thái:** ĐÃ CÓ TRONG TÀI LIỆU.
- **Trích dẫn chi tiết:**
  - [07-product-backlog.md](../02-planning/03-product-backlog.md#L108-L446) — **Mục 2. Chi tiết Product Backlog — User Story & Acceptance Criteria**:
...
- **Trạng thái:** ĐÃ CÓ TRONG TÀI LIỆU.
- **Trích dẫn chi tiết:**
  - [06-architecture.md](../02-planning/02-architecture.md#L160-L207) — **Mục 4. Góc nhìn logic (Logical View - C4 Model)**:
  ...
  - [06-architecture.md](../02-planning/02-architecture.md#L226-L240) — **Mục 4.2. Ngăn xếp công nghệ chi tiết (Technology Stack)**:
  ...
  - [06-architecture.md](../02-planning/02-architecture.md#L550) — **Mục 9.3. PoC 2: Kiểm chứng tích hợp liên thông Tech Stack E2E**:
...
- **Trạng thái:** ĐÃ CÓ TRONG TÀI LIỆU.
- **Trích dẫn chi tiết:**
  - [06-architecture.md](../02-planning/02-architecture.md#L550) — **Mục 9.2. PoC 1: Kiến trúc luồng xử lý OCR tiếng Việt bất đồng bộ (Hardest Core Feature)**:
...
- **Trích dẫn quy trình Git:**
  - [06-architecture.md](../02-planning/02-architecture.md#L537-L547) — **Mục 8.2. Chiến lược nhánh Git (Git Branching Strategy)**:
...
- **Trạng thái:** ĐÃ CÓ TRONG TÀI LIỆU.
- **Trích dẫn chi tiết:**
  - [08-cost-time-resource.md](../02-planning/04-cost-time-resource.md#L70-L178) — **Mục 2. Phương pháp luận ước lượng nỗ lực phần mềm (UCP & COCOMO II)**:
  ...
  - [08-cost-time-resource.md](../02-planning/04-cost-time-resource.md#L183-L202) — **Mục 3. Dự toán chi phí và Phân bổ ngân sách dự án (Cost & Budget Plan)**:
  ...
  - [08-cost-time-resource.md](../02-planning/04-cost-time-resource.md#L273-L314) & [09-ai-development-workflow-report.md](../03-execution-monitoring/03-ai-development-workflow.md#L44-L60) — **Mục 5.3 & Báo cáo Workflow AI**:
...
- **Trạng thái:** ĐÃ CÓ TRONG TÀI LIỆU.
- **Trích dẫn chi tiết:**
  - [05-project-charter.md](../01-initiation/04-project-charter.md#L103-L113) — **Mục 7. Cấu trúc phân rã công việc (WBS) và Tiến độ**:
    > Phân rã 6 gói công việc WBS (WP1 đến WP6) triển khai cuốn chiếu trong 20 tuần, go-live phiên bản MVP ở tuần 12.
  - [08-cost-time-resource.md](../02-planning/04-cost-time-resource.md#L50-L67) — **Mục 1. Kế hoạch thời gian và Tiến độ thực hiện (Time & Schedule Plan)**:
...
- **Trích dẫn chi tiết:**
  - [10-statement-of-work.md](../02-planning/05-statement-of-work.md#L53-L65) — **Mục 1. Mục đích và Ý nghĩa tài liệu**:
  ...
  - [10-statement-of-work.md](../02-planning/05-statement-of-work.md#L243-L250) — **Mục 8.2. Vai trò của AI Coding Assistants trong SOW**:
...
- **Trích dẫn mô hình dữ liệu & báo cáo:**
  - [08-cost-time-resource.md](../02-planning/04-cost-time-resource.md#L225-L271) — **Mục 5.1 & 5.2. Bộ chỉ số Giám sát & Cơ chế Session Logging**:
  ...
  - [09-ai-development-workflow-report.md](../03-execution-monitoring/03-ai-development-workflow.md#L44-L60) — **Mục 1 & 3. Kết quả tổng hợp dữ liệu thực tế**:
...
- **Nội dung bổ sung / Thao tác Demo thu thập dữ liệu trực tiếp:**
  - Kịch bản demo: (1) Developer thực hiện câu lệnh commit/merge story $\rightarrow$ (2) Chạy skill/tool ghi nhận 1 dòng log vào [`project_log.md`](../03-execution-monitoring/02-project-log.md) $\rightarrow$ (3) PM chạy script/tổng hợp bảng Throughput, Token AI và Cycle time cho báo cáo tuần.
