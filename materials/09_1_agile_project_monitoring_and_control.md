...
_(Establish the timeline for deliverables for each phase of the project.)_
...
1. Hôm qua tôi đã làm gì?
   _(What did I do yesterday?)_
2. Hôm nay tôi sẽ làm gì?
   _(What will I do today?)_
3. Những vấn đề nào đang ngăn cản tôi tiến bộ?
   _(What problems are preventing me from making progress?)_
...
> _(Under no circumstances should you change the iteration deadline.)_
...
_(Lesser-skilled developers should be able to bring ideas and changes to the team which may be valuable.)_

> _"Không có cái tôi trong tập thể. Không bỏ lại ai phía sau."_
> _(There's no "I" in Team. Leave no man behind.)_
...
_(Explain WHY it's the right way to follow with technical justifications.)_
...
_(Let people do what they're good at, but not to the extent where they are the only one who knows what's going on with that area.)_
...
_(Once you write code and check it in, it's no longer 'your' code, it's the team’s.)_
