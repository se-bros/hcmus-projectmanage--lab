...
| **09** | **Định nghĩa quy trình phát triển (Process)**     | Mô hình Agile/Kanban Spec-Driven theo Epic, WIP Limit = 1, gating review PR.                      | In tài liệu Định nghĩa quy trình (Mục 1.1 trong Backlog hoặc file quy trình riêng).                                                                           |
