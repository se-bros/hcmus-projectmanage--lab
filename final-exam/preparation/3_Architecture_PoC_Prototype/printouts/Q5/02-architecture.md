...
- [8. Quản lý cấu hình phần mềm và Chiến lược Git (SCM)](#8-quản-lý-cấu-hình-phần-mềm-và-chiến-lược-git-scm)
  - [8.1. Quy chuẩn định danh các Hạng mục cấu hình (Configuration Items - CIs)](#81-quy-chuẩn-định-danh-các-hạng-mục-cấu-hình-configuration-items-cis)
  - [8.2. Chiến lược nhánh Git (Git Branching Strategy)](#82-chiến-lược-nhánh-git-git-branching-strategy)
