...
2. **Chi phí chuyển đổi cao (High Switching Cost):** Hệ thống tích hợp sâu vào hạ tầng định danh LDAP/Keycloak và quy trình nghiệp vụ quản lý tài liệu hàng ngày của thư viện. Sau khi vận hành, việc chuyển sang giải pháp khác đồng nghĩa với việc phải di chuyển toàn bộ kho EPUB, chỉ mục Elasticsearch, phân quyền người dùng và đào tạo lại toàn bộ đội ngũ thủ thư — tạo rào cản chuyển đổi rất lớn.
