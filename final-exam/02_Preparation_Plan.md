...
| **Người 4:** Ân Tiến Nguyên An (23127148)     | **Ước lượng, Lập kế hoạch & Quy trình**          |     **Câu 9, 10, 11**      | `06-software-process-definition.md`, `04-cost-time-resource.md`, `01-sprint-plan.md`                | In **tài liệu Quy trình phát triển phần mềm độc lập** (Câu 9), bảng tính UCP/COCOMO II (Câu 10) và sơ đồ WBS đường găng (Câu 11).                                                                                                                                       |  [Xem chi tiết](./preparation/4_Estimation_Planning_Process/README.md)   |
| **Người 5:** Nguyễn Tuấn Anh (23127152)       | **CI/CD, DevOps & Kế hoạch Kiểm thử**            |   **Câu 13, 14, 15, 20**   | `02-architecture.md` (mục CI/CD), `docker-compose.yml`, test suite `src/backend/tests/`            | Viết script **Deploy Manual** (`scripts/deploy-prod.sh`); Triển khai kịch bản **CD tự động** (`.github/workflows/cd.yml`); Soạn tài liệu **Hướng dẫn cài đặt Dev & Triển khai Ops**; Soạn **Kế hoạch kiểm thử (Test Plan)**; Chuẩn bị ảnh chụp email/notification CI/CD. |      [Xem chi tiết](./preparation/5_CICD_DevOps_Testing/README.md)       |
