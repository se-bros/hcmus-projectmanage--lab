...
> *(Risk is the probability of suffering loss while pursuing goals due to factors that are unpredictable or beyond control.)*
...
*(Producing lists of the project-specific risk items likely to compromise a project's satisfactory outcome.)*
...
*(Risk analysis is the scientific measurement of the degree of danger or hazard involved in any operation or activity.)*
...
*Khả năng chấp nhận rủi ro (Risk Tolerance)* là mức độ sẵn lòng chấp nhận hoặc né tránh rủi ro của một cá nhân hoặc tổ chức.
...
Kế hoạch quản lý rủi ro được tổ chức theo tiêu chuẩn để trả lời các câu hỏi: *Tại sao, Cái gì, Khi nào, Ai, Ở đâu, Như thế nào và Bao nhiêu* \[IEEE Std 1540-2001\].
...
3. Hooman Hoodat & Hassan Rashidi (2009). *Classification and Analysis of Risks in Software Engineering*.
...
6. R. D. Shachter (1986). *Evaluating Influence Diagrams*.
